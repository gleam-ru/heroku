                    ...
                    '<div class="w-portfolio-item-h">',
                        '<div class="item">',
                            '<div class="head">',
                                ...
                                '<span class="percent" :class="{green: percent > 0, red: percent < 0}">{{percent}}<i class="fa fa-percent"></i></span>',
                                '<br/>',
                                '<span class="price-diff" :class="{green: priceDiff > 0, red: priceDiff < 0}">{{priceDiff}}<i class="fa fa-rub"></i></span>',
                            '</div>',
                            '<div class="center">',
                                '<p class="name">',
